...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("INSERT INTO discounts (product_id, discount_percent, start_date, end_date) VALUES (?,?,?,?)");
...
$products = $mysqli->query("SELECT product_id, name FROM product ORDER BY name");
...
<div class="container">
  ...
  <main class="content">
    ...
    <div class="card" style="margin-top:20px;">
      ...
      <table class="data">
        <thead><tr><th>ID</th><th>Product</th><th>Percent</th><th>Start</th><th>End</th><th>Action</th></tr></thead>
        <tbody>
