...
<body>
  ...
  <div class="product-detail">
    <div class="product-image">
      <img src="../../../assets/products/product_<?php echo htmlspecialchars($product['image_id'] ?? 'default'); ?>.png"
        ...
        <?php while ($related = $related_result->fetch_assoc()): ?>
          <div class="product-card">
            <a href="product.php?id=<?php echo $related['product_id']; ?>">
              <img src="../../../assets/products/product_<?php echo htmlspecialchars($related['image_id'] ?? 'default'); ?>.png"
  ...
  <script>
    ...
    function showNotification(msg, error = false) {
      ...
      notification.style.backgroundColor = error ? "#dc3545" : "#67ea6cff";
