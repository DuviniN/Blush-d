...
$sql =  "SELECT o.order_id, o.order_date, o.total_price, o.house_no, o.street1, o.street2, o.city, o.postal_code, o.payment_method,
        u.first_name, u.last_name, p.product_name, p.product_id, oi.quantity, oi.price
        FROM `order` o
            ...
            <div class="order-info">
                ...
                <ul>
                    <?php foreach ($order_items as $item): ?>
                        <li>
                            <img src="../../../assets/products/product_<?php echo $item['image_id']; ?>.png" alt="<?php echo htmlspecialchars($item['product_name']); ?>" style="width:50px; height:50px; vertical-align:middle;">
